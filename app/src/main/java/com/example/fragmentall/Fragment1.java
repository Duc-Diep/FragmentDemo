...
import com.example.fragmentall.databinding.LayoutFragment1Binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        binding.btnMoveToFr2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Fragment fragment = Fragment2.newInstance("Điệp",new Person("Đức Điệp",21),list);
                FragmentManager fragmentManager = getActivity().getSupportFragmentManager();
                fragmentManager.beginTransaction().replace(R.id.fragment_layout,fragment).addToBackStack(null).commit();
            }
        });
